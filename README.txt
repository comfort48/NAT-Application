...
3) How to run: - I tested on a Linux machine (UBUNTU) which has "make" installed. If not, just compile the  NAT_Application.cpp using "g++ NAT_Application.cpp" and run using "./a.out" command  
